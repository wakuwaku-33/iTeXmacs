...
(kbd-map
  ...
  ("symbol | var" "<divides>")
  ("symbol | var /" "<ndivides>")
  ("symbol | var var" "<shortmid>")
  ("symbol | var var /" "<nshortmid>")
  ("symbol | |" "<||>")
  ("symbol | | /" "<nparallel>")
  ...
  ("[ var var var" (math-bracket-open "]" "[" #f))
  ("]" (math-bracket-close "]" "[" #f))
  ("[ [" (twice (math-bracket-open "[" "]" #f)))
  ("] ]" (twice (math-bracket-close "]" "[" #f)))
  ("[ [ var" (math-bracket-open "<llbracket>" "<rrbracket>" #f))
  ("] ] var" (math-bracket-close "<rrbracket>" "<llbracket>" #f))
  ("{" (math-bracket-open "{" "}" #f))
  ("{ var" (math-bracket-open "<langle>" "<rangle>" #f))
  ...
  ("| ," (math-bracket-open "<lfloor>" "<rfloor>" #f))
  ("| , var" (math-bracket-open "<lfloor>" "<rceil>" #f))
  (", |" (math-bracket-close "<rfloor>" "<lfloor>" #f))
  ("| '" (math-bracket-open "<lceil>" "<rceil>" #f))
  ("| ' var" (math-bracket-open "<lceil>" "<rfloor>" #f))
  ("' |" (math-bracket-close "<rceil>" "<lceil>" #f))
  ("| accent:acute" (math-bracket-open "<lceil>" "<rceil>" #f))
  ("| accent:acute var" (math-bracket-open "<lceil>" "<rfloor>" #f))
  ("accent:acute |" (math-bracket-close "<rceil>" "<lceil>" #f))
  ...
  ("math:left | accent:acute" (math-bracket-open "lceil" "rceil" #t))
  ("math:left | accent:acute var" (math-bracket-open "lceil" "rfloor" #t))
  ("math:left accent:acute |" (math-bracket-open "rceil" "lceil" #t))
  ("math:left ." (math-bracket-open "." "." #t))
  ...
  ("math:left | accent:acute" (math-separator "lceil" #t))
  ("math:left accent:acute |" (math-separator "rceil" #t))
  ("math:middle ." (math-separator "." #t))
  ...
  ("math:right | accent:acute" (math-bracket-close "lceil" "rceil" #t))
  ("math:right accent:acute |" (math-bracket-close "rceil" "lceil" #t))
  ("math:right ." (math-bracket-close "." "." #t))

  ("math:large (" (math-bracket-open "(" ")" #t))
  ("math:large ( var" (math-bracket-open "." "." #t))
  ("math:large )" (math-bracket-close ")" "(" #t))
  ("math:large [" (math-bracket-open "[" "]" #t))
  ("math:large [ var" (math-bracket-open "[" "[" #t))
  ("math:large [ var var" (math-bracket-open "]" "]" #t))
  ("math:large [ var var var" (math-bracket-open "]" "[" #t))
  ("math:large ]" (math-bracket-close "]" "[" #t))
  ("math:large [ [" (twice (math-bracket-open "[" "]" #t)))
  ("math:large ] ]" (twice (math-bracket-close "]" "[" #t)))
  ("math:large [ [ var" (math-bracket-open "llbracket" "rrbracket" #t))
  ("math:large ] ] var" (math-bracket-close "llbracket" "rrbracket" #t))
  ("math:large {" (math-bracket-open "{" "}" #t))
  ("math:large }" (math-bracket-close "}" "{" #t))
  ("math:large <" (math-bracket-open "langle" "rangle" #t))
  ("math:large >" (math-bracket-close "rangle" "langle" #t))
  ("math:large |" (math-bracket-open "|" "|" #t))
  ("math:large | var" (math-separator "|" #t))
  ("math:large | |" (math-bracket-open "||" "||" #t))
  ("math:large | | var" (math-separator "||" #t))
  ("math:large /" (math-bracket-open "/" "\\"#t))
  ("math:large / var" (math-separator "/" #t))
  ("math:large \\" (math-bracket-open "\\" "/" #t))
  ("math:large \\ var" (math-separator "\\" #t))
  ("math:large | ," (math-bracket-open "lfloor" "rfloor" #t))
  ("math:large , |" (math-bracket-close "rfloor" "lfloor" #t))
  ("math:large | '" (math-bracket-open "lceil" "rceil" #t))
  ("math:large ' |" (math-bracket-close "rceil" "lceil" #t))
  ("math:large | accent:acute" (math-bracket-open "lceil" "rceil" #t))
  ("math:large accent:acute |" (math-bracket-close "rceil" "lceil" #t))
  ...
  ("| var var var" "<sqcup>")
  ("| var var var var" "|")
  ("| var var var var /" "<nmid>")
  ("| var var var var var" "<divides>")
  ("| var var var var var /" "<ndivides>")
  ("| var var var var var var" "<shortmid>")
  ("| var var var var var var /" "<nshortmid>")
  ("| | var" "<||>")
  ("| | var /" "<nparallel>")
  ("| | var var" "<shortparallel>")
  ("| | var var /" "<nshortparallel>")
  ("| | | var" "<interleave>")
  ...
  ("math:greek |" "|")
  ("math:greek | /" "<nmid>")
  ("math:greek | var" "<divides>")
  ("math:greek | var /" "<ndivides>")
  ("math:greek | var var" "<shortmid>")
  ("math:greek | var var /" "<nshortmid>")
  ("math:greek | |" "<||>")
