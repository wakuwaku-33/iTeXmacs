...
(kbd-map
  ...
  ("math:small | accent:acute" (math-bracket-open "<lceil>" "<rceil>" #f))
  ("math:small accent:acute |" (math-bracket-close "<rceil>" "<lceil>" #f))
  ...
  ("(" (math-bracket-open "(" ")" #t))
  ("( var" (math-bracket-open "." "." #t))
  ("( space" (math-bracket-open "." "." #t))
  (")" (math-bracket-close ")" "(" #t))
  ("[" (math-bracket-open "[" "]" #t))
  ("[ var" (math-bracket-open "[" "[" #t))
  ("[ var var" (math-bracket-open "]" "]" #t))
  ("[ var var var" (math-bracket-open "]" "[" #t))
  ("]" (math-bracket-close "]" "[" #t))
  ("[ [" (twice (math-bracket-open "[" "]" #t)))
  ("] ]" (twice (math-bracket-close "]" "[" #t)))
  ("[ [ var" (math-bracket-open "llbracket" "rrbracket" #t))
  ("] ] var" (math-bracket-close "rrbracket" "llbracket" #t))
  ("{" (math-bracket-open "{" "}" #t))
  ("{ var" (math-bracket-open "langle" "rangle" #t))
  ("{ var var" (math-bracket-open "<llangle>" "<rrangle>" #f))
  ("{ {" (twice (math-bracket-open "{" "}" #t)))
  ("{ { var" (math-bracket-open "<llangle>" "<rrangle>" #f))
  ("}" (math-bracket-close "}" "{" #t))
  ("} var" (math-bracket-close "rangle" "langle" #t))
  ...
  ("| , var" (math-bracket-open "lfloor" "rceil" #t))
  (", |" (math-bracket-close "rfloor" "lfloor" #t))
  ("| '" (math-bracket-open "lceil" "rceil" #t))
  ("| ' var" (math-bracket-open "lceil" "rfloor" #t))
  ("' |" (math-bracket-close "rceil" "lceil" #t))
  ("| accent:acute" (math-bracket-open "lceil" "rceil" #t))
  ("| accent:acute var" (math-bracket-open "lceil" "rfloor" #t))
  ("accent:acute |" (math-bracket-close "rceil" "lceil" #t))
  ...
  ("< var var var var var" (math-bracket-open "langle" "rangle" #t))
  ("> var var var var var" (math-bracket-close "rangle" "langle" #t))
  ("< < var var" (math-bracket-open "llangle" "rrangle" #t))
  ("> > var var" (math-bracket-close "rrangle" "llangle" #t))
  ...
  ("| var var var var /" "<ndivides>")
  ("| var var var var var" "<shortmid>")
  ("| var var var var var /" "<nshortmid>")
  ("| var var var var var var" (math-separator "|" #t))
  ("| var var var var var var /" "<nmid>")
  ("| | var" (math-separator "||" #t))
  ("| | var /" "<nparallel>")
