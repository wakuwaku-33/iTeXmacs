...
(define-preferences
  ...
  ("synonym correct" "off" (lambda args (noop)))
  ("manual matching brackets" "on" (lambda args (noop)))
  ("manual with correct" "on" (lambda args (noop)))
  ("manual remove superfluous invisible" "on" (lambda args (noop)))
  ("manual insert missing invisible" "on" (lambda args (noop)))
  ("manual synonym correct" "on" (lambda args (noop)))
